...
const WhatsAppButton: React.FC = () => {
  const phoneNumber = '+918097074455'; // Yugrow Pharmacy number
  const message = encodeURIComponent("Hello, I have a query for Yugrow Pharmacy.");
  ...
  const contactStructuredData = {
    ...
    "description": "Customer support for Yugrow Pharmacy",
    "url": "https://yugrowpharmacy.com/contact"
  };
    ...
    <>
      ...
      <a 
        ...
        className={cn(
          ...
          "w-14 h-14 bg-[#25D366] hover:bg-[#20BD5C] rounded-full shadow-lg",
          "flex items-center justify-center",
          "transition-all duration-300 hover:scale-110"
        )}
        aria-label="Contact us on WhatsApp"
        title="Contact Yugrow Pharmacy on WhatsApp"
      >
