              ...
              >
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <div>
                    <Button 
                      type="submit"
                      className="w-full bg-[#FF7E3D] hover:bg-[#FF7E3D]/80 text-white py-2 rounded-md transition-colors flex items-center justify-center gap-2"
                      disabled={isSubmitting}
                    >
                      {isSubmitting ? "Submitting..." : "Submit Inquiry"} {!isSubmitting && <ArrowRight size={18} />}
                    </Button>
                  </div>
                </form>
              </motion.div>
