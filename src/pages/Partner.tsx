                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-md text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-[#FF7E3D]"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-md text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-[#FF7E3D]"
                      placeholder="Tell us about your expectations or ask questions..."
                    ></textarea>
                  </div>
                  <div className="pt-2">
                    <ReCaptcha 
                  ...
                  <div>
                    <Button
                      type="submit"
                      className="w-full bg-[#FF7E3D] hover:bg-[#FF7E3D]/80 text-white py-3"
